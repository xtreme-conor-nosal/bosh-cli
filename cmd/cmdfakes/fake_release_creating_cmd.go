...
type FakeReleaseCreatingCmd struct {
	RunStub        func(boshopts.CreateReleaseOpts) (boshrel.Release, error)
	runMutex       sync.RWMutex
	runArgsForCall []struct {
		arg1 boshopts.CreateReleaseOpts
	}
	runReturns struct {
...
func (fake *FakeReleaseCreatingCmd) Run(arg1 boshopts.CreateReleaseOpts) (boshrel.Release, error) {
	fake.runMutex.Lock()
...
func (fake *FakeReleaseCreatingCmd) RunArgsForCall(i int) boshopts.CreateReleaseOpts {
	fake.runMutex.RLock()
	defer fake.runMutex.RUnlock()
